...
async function seed() {
  ...
  await Product.insertMany([
    // --- CATEGORY 1: Skincare (8 Products) ---
    {
      ...
      images: [{ url: '/images/products/bareo-cica-niacinamide-serum.png', alt: 'Bareo Cica Serum' }],
      status: 'active',
    },
    {
      sku: 'BAR-SK-002',
      ...
      images: [{ url: '/images/products/bareo-hyaluronic-hydrator.png', alt: 'Bareo Dewy Barrier' }],
      status: 'active',
    },
    {
      sku: 'BAR-SK-003',
    ...
    },
    {
      ...
      images: [{ url: '/images/products/bareo-salicylic-face-wash.png', alt: 'Bareo Salicylic Cleanser' }],
      status: 'active',
    },
    {
      sku: 'BAR-SK-005',
      ...
      images: [{ url: '/images/products/bareo-sunscreen-spf50.png', alt: 'Bareo Fluid Sunscreen' }],
      status: 'active',
    },
    {
      sku: 'BAR-SK-006',
    ...
    },
    {
      ...
      images: [{ url: '/images/products/bareo-argan-conditioner.png', alt: 'Bareo Conditioner' }],
      status: 'active',
    },
    {
      sku: 'BAR-HC-003',
    ...
    },
    {
      ...
      images: [{ url: '/images/products/bareo-keratin-hair-mask.png', alt: 'Bareo Keratin Mask' }],
      status: 'active',
    },
    {
      sku: 'BAR-HC-006',
      ...
      images: [{ url: '/images/products/bareo-anti-frizz-hair-serum.png', alt: 'Bareo Leave In Serum' }],
      status: 'active',
    },
    {
      sku: 'BAR-HC-007',
    ...
    },
    {
      ...
      images: [{ url: '/images/products/bareo-coffee-body-scrub.png', alt: 'Bareo Body Scrub' }],
      status: 'active',
    },
    {
      sku: 'BAR-BC-004',
    ...
    // --- CATEGORY 4: Baby Care (6 Products - All Mapped to bareo-cica-serum.png) ---
    {
      ...
      images: [{ url: '/images/products/bareo-baby-wash.png', alt: 'Bareo Baby Wash' }],
      status: 'active',
    },
    {
      sku: 'BAR-BB-002',
      ...
      images: [{ url: '/images/products/bareo-baby-lotion.png', alt: 'Bareo Baby Lotion' }],
      status: 'active',
    },
    {
      sku: 'BAR-BB-003',
      ...
      images: [{ url: '/images/products/bareo-diaper-rash-cream.png', alt: 'Bareo Diaper Rash Cream' }],
      status: 'active',
    },
    {
      sku: 'BAR-BB-004',
      ...
      images: [{ url: '/images/products/bareo-baby-massage-oil.png', alt: 'Bareo Baby Massage Oil' }],
      status: 'active',
    },
    {
      sku: 'BAR-BB-005',
      ...
      images: [{ url: '/images/products/bareo-baby-face-butter.png', alt: 'Bareo Baby Face Butter' }],
      status: 'active',
    },
    {
      sku: 'BAR-BB-006',
      ...
      images: [{ url: '/images/products/bareo-baby-powder.png', alt: 'Bareo Baby Powder' }],
      status: 'active',
    },
  
    // --- ADDITIONS: Skincare (p29, p30) ---
    {
      sku: 'BAR-SK-009',
      slug: 'bareo-renew-retinol-bakuchiol-serum',
      name: 'Bareo Renew Retinol & Bakuchiol Serum 0.3%',
      brand: 'Bareo',
      categoryId: categories[0]._id.toString(),
      categoryName: categories[0].name,
      categorySlug: categories[0].slug,
      shortDescription: 'Nightly cell renewal serum with 0.3% Encapsulated Retinol & Bakuchiol',
      description: 'Bareo Renew Retinol Serum smooths fine lines, improves skin elasticity, and refines texture with gentle 0.3% Retinol and Bakuchiol.',
      mrp: 449, offerPrice: 349, discount: 22,
      rating: 4.9, ratingCount: 142, stock: 85,
      isBestSeller: true, isTrending: true, isDoctorRecommended: true, isNewProduct: true, isAiRecommended: true,
      skinTypes: ['normal', 'combination', 'dry'],
      concerns: ['fine-lines', 'aging', 'texture'],
      benefits: ['Smooths fine lines and wrinkles', 'Refines skin texture', 'Boosts collagen production'],
      usage: ['Apply 2-3 drops nightly onto clean skin before cream.'],
      keyFacts: ['0.3% Encapsulated Retinol', 'Bakuchiol Enriched'],
      tags: ['retinol', 'bakuchiol', 'serum'],
      images: [{ url: '/images/products/bareo-retinol-serum.png', alt: 'Bareo Retinol Serum' }],
      status: 'active',
    },
    {
      sku: 'BAR-SK-010',
      slug: 'bareo-hydrate-hyaluronic-acid-serum',
      name: 'Bareo Hydrate Hyaluronic Acid Serum 2%',
      brand: 'Bareo',
      categoryId: categories[0]._id.toString(),
      categoryName: categories[0].name,
      categorySlug: categories[0].slug,
      shortDescription: 'Multi-depth hydration serum with 2% Hyaluronic Acid & Ceramides',
      description: 'Instantly plump dehydrated skin and restore barrier moisture balance with Bareo 2% Hyaluronic Acid Serum.',
      mrp: 399, offerPrice: 299, discount: 25,
      rating: 4.8, ratingCount: 175, stock: 110,
      isBestSeller: true, isTrending: false, isDoctorRecommended: true, isNewProduct: true, isAiRecommended: true,
      skinTypes: ['dry', 'sensitive', 'normal', 'combination', 'oily'],
      concerns: ['dryness', 'dehydration'],
      benefits: ['Instant deep hydration', 'Plumps skin texture', 'Locks in moisture barrier'],
      usage: ['Apply 3 drops to damp skin morning and night.'],
      keyFacts: ['2% Hyaluronic Acid', 'Ceramides Fortified'],
      tags: ['hyaluronic-acid', 'ceramides', 'serum'],
      images: [{ url: '/images/products/bareo-hyaluronic-serum.png', alt: 'Bareo Hyaluronic Serum' }],
      status: 'active',
    },

    // --- ADDITIONS: Hair Care (p31) ---
    {
      sku: 'BAR-HC-008',
      ...
      categoryName: categories[1].name,
      categorySlug: categories[1].slug,
      shortDescription: 'Targeted anti-flake scalp shampoo with Salicylic Acid & Zinc PCA',
      description: 'Bareo Anti-Dandruff Shampoo clears persistent scalp flakes, controls excess sebum, and calms scalp itchiness without stripping moisture.',
      mrp: 399, offerPrice: 299, discount: 25,
      rating: 4.8, ratingCount: 198, stock: 95,
      isBestSeller: true, isTrending: true, isDoctorRecommended: true, isNewProduct: true, isAiRecommended: true,
      skinTypes: ['all'],
      concerns: ['dandruff', 'scalp-care'],
      benefits: ['Clears scalp flakes', 'Reduces itchiness', 'Balances scalp oil'],
      usage: ['Lather into wet scalp for 2-3 minutes and rinse thoroughly.'],
      keyFacts: ['Salicylic Acid', 'Zinc PCA Flake Control'],
      tags: ['anti-dandruff', 'shampoo', 'scalp-reset'],
      images: [{ url: '/images/products/bareo-anti-dandruff-shampoo.png', alt: 'Bareo Anti Dandruff Shampoo' }],
      status: 'active',
    },

    // --- ADDITIONS: Body Care (p32) ---
    {
      sku: 'BAR-BC-008',
      ...
      categoryName: categories[2].name,
      categorySlug: categories[2].slug,
      shortDescription: 'Refreshing hydrating body spray with Rose Water, Aloe & White Musk',
      description: 'Bareo Mist Veil refreshes and hydrates body skin with a delicate veil of Rose Water and Aloe Vera while leaving a subtle scent.',
      mrp: 349, offerPrice: 269, discount: 22,
      rating: 4.7, ratingCount: 110, stock: 80,
      isBestSeller: false, isTrending: true, isDoctorRecommended: false, isNewProduct: true, isAiRecommended: false,
      skinTypes: ['all'],
      concerns: ['dryness', 'refreshment'],
      benefits: ['Instant skin refreshment', 'Lightweight hydration mist'],
      usage: ['Mist all over body after shower or whenever needed.'],
      keyFacts: ['Organic Rose Water', 'Aloe Vera Infused'],
      tags: ['body-mist', 'rose-water'],
      images: [{ url: '/images/products/bareo-body-mist.jpg', alt: 'Bareo Body Mist' }],
      status: 'active',
    },

    // --- ADDITIONS: Baby Care (p33, p34, p35) ---
    {
      sku: 'BAR-BB-007',
      ...
      categoryName: categories[3].name,
      categorySlug: categories[3].slug,
      shortDescription: 'Ultra-gentle tear-free scalp wash with Oat Extract & Aloe Vera',
      description: 'Bareo Baby Shampoo cleanses delicate baby hair and scalp without eye sting or dryness. Pediatrician approved.',
      mrp: 299, offerPrice: 229, discount: 23,
      rating: 4.9, ratingCount: 160, stock: 120,
      isBestSeller: true, isTrending: false, isDoctorRecommended: true, isNewProduct: true, isAiRecommended: true,
      skinTypes: ['sensitive', 'baby'],
      concerns: ['baby-care', 'scalp-care'],
      benefits: ['100% Tear-Free certified', 'Protects delicate baby scalp'],
      usage: ['Apply small amount on wet baby hair, lather gently and rinse.'],
      keyFacts: ['Pediatrician Approved', 'Tear-Free'],
      tags: ['baby-shampoo', 'tear-free'],
      images: [{ url: '/images/products/bareo-baby-shampoo.png', alt: 'Bareo Baby Shampoo' }],
      status: 'active',
    },
    {
      sku: 'BAR-BB-008',
      slug: 'bareo-gentle-baby-cleansing-wipes',
      name: 'Bareo Gentle Baby Cleansing Wipes (72 Wipes)',
      brand: 'Bareo',
      categoryId: categories[3]._id.toString(),
      categoryName: categories[3].name,
      categorySlug: categories[3].slug,
      shortDescription: 'Fragrance-free cleansing wipes with Aloe Vera & Chamomile',
      description: 'Bareo Baby Wipes gently clean baby hands, face, and diaper area. Made with pure water, Aloe Vera, and Chamomile.',
      mrp: 199, offerPrice: 149, discount: 25,
      rating: 4.9, ratingCount: 240, stock: 200,
      isBestSeller: true, isTrending: true, isDoctorRecommended: true, isNewProduct: true, isAiRecommended: true,
      skinTypes: ['sensitive', 'baby'],
      concerns: ['baby-care', 'cleansing'],
      benefits: ['Ultra-soft plant fibers', 'Fragrance-free pH balanced'],
      usage: ['Use to gently wipe baby face, hands, or bottom.'],
      keyFacts: ['Fragrance-Free', 'Aloe & Chamomile'],
      tags: ['baby-wipes', 'cleansing-wipes'],
      images: [{ url: '/images/products/bareo-baby-wipes.png', alt: 'Bareo Baby Wipes' }],
      status: 'active',
    },
    {
      sku: 'BAR-BB-009',
      ...
      categoryName: categories[3].name,
      categorySlug: categories[3].slug,
      shortDescription: 'Soothing protective balm with Organic Shea Butter & Vitamin E',
      description: 'Bareo Baby Lip Balm protects baby lips and dry cheeks against chapping and drool rash with pure Shea Butter and Vitamin E.',
      mrp: 199, offerPrice: 149, discount: 25,
      rating: 4.8, ratingCount: 95, stock: 100,
      isBestSeller: false, isTrending: false, isDoctorRecommended: true, isNewProduct: true, isAiRecommended: false,
      skinTypes: ['sensitive', 'baby'],
      concerns: ['dry-lips', 'chafing'],
      benefits: ['Protects baby lips from chapping', 'Food-grade safe balm'],
      usage: ['Apply gently on baby lips and dry cheeks.'],
      keyFacts: ['Shea Butter & Vitamin E', 'Pediatrician Tested'],
      tags: ['baby-balm', 'lip-balm'],
      images: [{ url: '/images/products/bareo-baby-lip-balm.png', alt: 'Bareo Baby Lip Balm' }],
      status: 'active',
    },
])
